...
/**
 * Test for /persons/{personId}/ingestions
 */
Test('/persons/{personId}/ingestions', function (t) {
    ...
    t.test('test  get operation', function (t) {
      Mockgen().requests({
        ...
        request.end(function (err, res) {
          ...
          var validate = Validator(api.paths['/persons/{personId}/ingestions']['get']['responses']['200']['schema']);
    ...
    t.test('test  post operation', function (t) {
      Mockgen().requests({
        ...
        request.end(function (err, res) {
          ...
          var Validator = require('is-my-json-valid');
          var validate = Validator(api.paths['/persons/{personId}/ingestions']['post']['responses']['201']['schema']);
          var response = res.body;
          if (Object.keys(response).length <= 0) {
            response = res.text;
          }
